...
export class LoginServiceService {
  ...
  api = '';
  setLogInApi() {
    this.api = 'https://api.coolieno1.in/v1.0/providers/provider-auth/login';
    console.log(this.api);
  }
  setSignUpApi() {
    this.api = 'https://api.coolieno1.in/v1.0/providers/provider-auth/signup';
    console.log(this.api);
  }
  ...
  verifyOtp(otp: any): Observable<any> {
    ...
    const api =
      'https://api.coolieno1.in/v1.0/providers/provider-auth/verify-otp';
...
// get api for sub categories
  ...
  getPhoneNumber(): Observable<any> {
    ...
    const api = `https://api.coolieno1.in/v1.0/providers/provider-auth/${id}`;
